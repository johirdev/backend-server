...
-------------------------------------
This project only contains the backend. For the frontend, use this modular structure for clarity and scalability:
...
- src/
  ...
  - pages/
    - auth/
      ...
      - Register.tsx
    - notes/
      - NotesList.tsx    # paginated list of user's notes
      - NoteEditor.tsx   # create/update note
  ...
  - components/
    - ui/ (buttons, inputs)
    - auth/ (PrivateRoute, role guard)
  - services/
    - api.ts            # axios/fetch wrapper with JWT interceptors
    - notes.service.ts
    - users.service.ts
    - posts.service.ts
  - hooks/
